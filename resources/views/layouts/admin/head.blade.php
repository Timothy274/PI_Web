...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="index.html"><img src="/images/logo.png" class="img-responsive logo ftco-animate"></a>
        </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#"><i class="lnr lnr-user"></i> <span>Log Out</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div id="sidebar-nav" class="sidebar ftco-animate">
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    <li><a href="index.html" class=""><span>Dashboard</span></a></li>
                    <li><a href="elements.html" class=""><span>News</span></a></li>
                    <li><a href="charts.html" class=""><span>Pelanggan</span></a></li>
                    <li><a href="panels.html" class=""><span>Pesanan</span></a></li>
                    <li><a href="notifications.html" class=""><span>Total Penjualan</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
